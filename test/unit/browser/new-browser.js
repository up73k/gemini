...
describe('browser/new-browser', () => {
    ...
    describe('launch', () => {
        ...
        describe('catch error on wd init ', () => {
            ...
            it('should fail with the message from e.message', () => {
            ...
            it('should fail with the message from e.data', () => {
            ...
            it('should fail without reason in error message', () => {
                wd.init.returns(Promise.reject({message: 'defaultError'}));
            ...
            it('should cut all tags from error', () => {
                wd.init.returns(Promise.reject({data: '<title></title><body>Error</body>'}));
            ...
            it('should cut internal tags from body tag', () => {
                wd.init.returns(Promise.reject({data: '<body><h1>Error</h1> text</body>'}));

                return launchBrowser()
                    .catch((e) => assert.notInclude(e.message, '<h1>'));
            });
